...
export interface IBaseNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface IBaseNFT extends BaseContract {
  connect(runner?: ContractRunner | null): IBaseNFT;
  waitForDeployment(): Promise<this>;

  interface: IBaseNFTInterface;
